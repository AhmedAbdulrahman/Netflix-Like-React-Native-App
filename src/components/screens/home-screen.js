...
const UserNavigationLinkText = styled.Text`color: ${COLORS.WHITE.WHITE};`;
...
const SubHeaderTitleText = styled.Text`color: ${COLORS.WHITE.WHITE};`;

const SubHeaderText = styled.Text`color: ${COLORS.GREY.BRIGHT_GREY};`;
...
const IconContainer = styled.View`margin-right: 10;`;
