...
const TitleText = styled.Text`color: ${COLORS.WHITE.WHITE};`;
...
const SummaryText = styled.Text`color: ${COLORS.WHITE.WHITE};`;

const SummaryHeader = styled(SummaryText)`margin-bottom: 15;`;
...
const PlayIconContainer = styled.View`margin-left: 10;`;
